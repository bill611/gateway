 ...
 * @param[in] ifname @n Specify the interface name tobind.The NULL value indicates the default network interface.
 * @return
   @verbatim
   =  0, success.
   <  0, fail.
 ...
 * @note.
 */
int platform_socket_device_bindto(long *handle, const char *ifname);
...
/**
 * @brief Read ali dev data from the start of configure zone.
 *
 * @param[in] buffer @n A pointer to a buffer to receive incoming data.
 * @param[in] length @n Specify read length, in bytes.
 * @return
 ...
 * @note None.
 */
int platform_kv_read( char *buffer, int length );


/**
 * @brief Write ali dev data from the start of configure zone.
 *
 * @param[in] buffer @n A pointer to a buffer to receive incoming data.
 * @param[in] length @n Specify write length, in bytes.
 * @return
 ...
 * @note None.
 */
int platform_kv_write( const char *buffer, int length );
...
enum TC_AUTH_TYPE {
	TC_AUTH_TYPE_OPEN = 0,
	TC_AUTH_TYPE_SHARED = 0x0001,
	TC_AUTH_TYPE_WPAPSK = 0x0002,
	TC_AUTH_TYPE_WPA8021X = 0x0004,
	TC_AUTH_TYPE_WPA2PSK = 0x0008,
	TC_AUTH_TYPE_WPA28021X = 0x0010,
	TC_AUTH_TYPE_WPAPSKWPA2PSK = 0x0020,
