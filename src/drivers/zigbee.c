...
static char zigbee_net_channel = 0xff;		//信道
...
/*********************************************************************************************************
** Descriptions:       zigbee透传数据通过串口发送去出
** input parameters:   dst_addr 目标地址 data要发送的数据指针 len数据长度
** output parameters:  -
** Returned value:     -
*********************************************************************************************************/
